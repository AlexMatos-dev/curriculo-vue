        ...
        for($o = 0; $o < $limit; $o++){
            ...
            try {
                ...
                $job = JobList::create([
                    ...
                    'job_title' => $faker->jobTitle() . ' ' . $profession['profession_name'],
                    'job_city' => $faker->city(),
                    'job_state' => $faker->city(),
                    'job_country' => $countryObj->lcountry_id,
                    'job_seniority' => $seniorityOfJob['proficiency_id'],
                    'minimum_wage' => $faker->numberBetween(random_int(200, 1500), random_int(1600, 4000)),
                    'max_wage' => $faker->numberBetween(random_int(4000, 6000), random_int(6001, 8000)),
